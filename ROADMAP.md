...
| ⏳     | Drizzle schema + migrations (users, accounts, auth, sessions, queue, slots, lyrics, abuse)                                                                                                                                                         |
...
| ⏳     | Auth & claims: OAuth/OIDC login, email/password fallback, sessions, claim middleware, account membership                                                                                                                                           |
...
| ⏳     | Generic music-provider OAuth routes (Spotify first)                                                                                                                                                                                                |
| ⏳     | Guest identity + slot system + expiry job                                                                                                                                                                                                          |
| ⏳     | Angular 21 OSS frontend template — guest request page (free-tier states)                                                                                                                                                                           |
| ⏳     | Angular 21 OSS frontend template — host dashboard (basic free-tier)                                                                                                                                                                                |
| ⏳     | Docker Compose OSS demo + smoke test in CI                                                                                                                                                                                                         |
